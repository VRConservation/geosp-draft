...
The GIS guy mumbles look it up on Google Earth Engine. Yes you've heard of this, you're thinking Google Earth, it will be easy, but you check out Earth Engine and find a console with an empty map and the Javascript and Python guides are another universe, let alone language, to you. You do a little more research and start to uncover no-code solutions to geospatial analysis.  
...
![aboveground | 650](https://i.imgur.com/z3xt9WD.png)
...
```
You can zoom the map out and center to approximately world level by changing line 10 of the code to
```javascript
...
## Next
Running Google Earth Enging in Python, QGIS, and ArcGIS pro.
